...
<div style="width:50%">
    <h1>FaQ Ekle</h1>
    <form method="post" action="{{route('faqcreate')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <textarea id="editor" type="text" class="form-control" placeholder="answer" name="answer"></textarea>
        </div>
        <div class="form-group">
